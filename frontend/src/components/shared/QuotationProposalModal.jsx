...
import QuotationProposalForm from '../documents/QuotationProposalForm';
import { formatTicketId } from '../../utils/roleIds';

export default function QuotationProposalModal({ ticket, onClose, onSuccess }) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-100 bg-white shrink-0">
          <div>
            <h2 className="text-xl font-bold text-slate-800">Project Quotation & Terms</h2>
