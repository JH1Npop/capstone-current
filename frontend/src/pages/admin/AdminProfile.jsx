          ...
          <section className="mb-6 space-y-4">
            <ProfileIdentityCard user={user} displayName={displayName} username={user?.username} profileImage={profileImagePreview} editing={isEditing} onEdit={() => setIsEditing(true)}>
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-brand-50 px-2.5 py-1 text-brand-700">
                Permissions: {scopeLabels[scope] || 'Custom administration'}
              </span>
            </ProfileIdentityCard>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Details used for account communication and identification.</p>
              </div>
