...
class InventoryCategory(models.Model):
    id = models.BigAutoField(primary_key=True, db_column='inventory_category_id')
...
class InventoryItem(models.Model):
    id = models.BigAutoField(primary_key=True, db_column='inventory_item_id')
    ...
    unit_of_measurement = models.CharField(
        ...
        blank=True,
        default='piece',
        help_text="Management-defined unit, e.g. piece, meter, set, roll.",
    )
...
class InventoryReservation(models.Model):
    id = models.BigAutoField(primary_key=True, db_column='inventory_reservation_id')
...
class ServiceTypeInventoryRequirement(models.Model):
    id = models.BigAutoField(primary_key=True, db_column='service_type_inventory_requirement_id')
